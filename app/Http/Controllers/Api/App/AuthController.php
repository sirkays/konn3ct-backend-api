...
//            echo $e;
    ...
    public function validateMeetingkv4(Request $request)
    {
        ...
        return response()->json(['success' => true, 'message' => 'Meeting validated successfully', 'access_code' => $room->password_attendee == "" ? false : true, 'data' => ['name' => $room->name, 'id' => $room->internalMeetingID, 'display_image' => $room->owner->profile_photo_url ], 'owner' => $room->owner->firstname . " " . $room->owner->lastname]);
    }
}
