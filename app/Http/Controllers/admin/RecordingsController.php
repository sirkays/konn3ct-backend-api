...
class RecordingsController extends Controller
{
    public function show(){
        ...
        $rc=RoomModel::count();
        $r=RoomModel::first();
        $datas['rooms']=RoomModel::latest()->paginate(600);
        $r210 =$datas['rooms']->toArray();
...
//            foreach ($r21 as $r210){
//                array_push($fer,$r210->internalMeetingID);
//            }
...
//                'meetingID' => $r->id,
                    ...
                    //'recordID' => 'a3f1s',
                    //'recordID' => ['xyz.1','pqr.1'] //pass as array note :If a recordID is specified, the meetingID is ignored.
//                     'state' => true // It can be a set of states separate by commas
                ]);
            }
