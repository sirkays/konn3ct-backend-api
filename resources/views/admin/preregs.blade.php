                ...
                <div class="box box-body pull-up">
                    <div class="flexbox align-items-end pt-30">
                        <div>
                            ...
                            <h6 class="text-uppercase text-dark-50 mb-0">Total Prereg</h6>
                        </div>
                ...
                <div class="box">
                    <div class="box-header">
                        <h4 class="box-title align-items-start flex-column">
                            Preregs
                            <small class="subtitle">This table show the list of pre-registration links created </small>
                        </h4>
                        ...
                        <div class="table-responsive">
                            <table class="table no-border table-striped" id="complex_header" style="width:100%">
                                ...
                                <tr class="text-uppercase bg-lightest">
                                    ...
                                    <th style="min-width: 50px"><span class="text-fade">Event Title</span></th>
                                    <th style="min-width: 50px"><span class="text-fade">Room Name</span></th>
                                    <th style="min-width: 70px"><span class="text-fade">Prereg URL</span></th>
                                    <th style="min-width: 10px"><span class="text-fade">Status</span></th>
                                    <th style="min-width: 10px"><span class="text-fade">Owner</span></th>
                                    <th style="min-width: 10px"><span class="text-fade">Date & Time</span></th>
                                    <th></th>
                                </tr>
                                </thead>
                                <tbody>
                                @foreach($preregs as $data)
                                    <tr>
                                        <td>{{$i++}}</td>
                                        <td class="pl-0 py-8">
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <a href="#"
                                                       class="text-dark font-weight-600 hover-primary mb-1 font-size-16">{{$data->title}}</a>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                                <span id="c{{$data->id}}"
                                                    ...
                                                    <a href="{{url('/preregistration/')}}/{{$data->reference}}"
                                                       style="font-size: 10px">{{url('/preregistration/')}}/{{$data->reference}}</a>
												</span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="preregs/{{$data->id}}" class="btn btn-primary btn-sm">View
                                                Details</a>
                                        </td>
                                    </tr>
                                @endforeach
