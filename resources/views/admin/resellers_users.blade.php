            ...
            <div class="col-4">
                <div class="box box-body pull-up">
                    <div class="flexbox align-items-end pt-30">
                        ...
                        <span class="icon-User font-size-80 text-info"><span class="path1"></span><span
            ...
            <div class="col-4">
                <div class="box box-body pull-up">
                    <div class="flexbox align-items-end pt-30">
                        ...
                        <span class="icon-User font-size-80 text-primary"><span class="path1"></span><span
                                class="path2"></span></span>
                    </div>
                </div>
            </div>
            <div class="col-4">
                <div class="box box-body pull-up">
                    <div class="flexbox align-items-end pt-30">
                        ...
                        <span class="icon-User font-size-80 text-danger"><span class="path1"></span><span
                                class="path2"></span></span>
                    </div>
                </div>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pl-0 py-8">
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <a href="#"
                                                       class="text-dark font-weight-600 hover-primary mb-1 font-size-16">{{$user->firstname}} {{$user->lastname}}</a>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <span>
                                                ...
                                                @elseif($user->plan==2)
                                                    ...
                                                    @else
                                                        Expires
                                                        in {{\Carbon\Carbon::now()->diffInDays(\Carbon\Carbon::parse($user->subscription), false)}}
                                                        days
                                                    @endif
                                                @else
                                                    @if($user->subscription=='new')
