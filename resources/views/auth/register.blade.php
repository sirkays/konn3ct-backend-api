...
@section('content')
    <x-guest-layout>
        ...
        <div class="row bg-gray-100">
            ...
            <div class="col-6">
                <div class="text-center" style="font-weight: bolder">For Personal</div>
            ...
            <div class="col-6">
                <div class="text-center" style="font-weight: bolder">For Corporate</div>
                <x-jet-authentication-card>
                    <x-slot name="logo">
                    </x-slot>
                    ...
                    <form method="POST" action="{{ route('register') }}" onsubmit="return checkform2(this);">
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-12">
                                ...
                                <x-jet-input id="firstname" class="block mt-1 w-full" type="text" name="firstname" :value="old('firstname')" required autofocus autocomplete="firstname" />
                                <x-jet-input class="block mt-1 w-full" type="hidden" name="type" value="biz" required autofocus autocomplete="firstname" />
                            </div>
                        ...
                        <div class="block mt-4 text-center">
                            ...
                            <div class="capbox">
                                ...
                                <div class="capbox-inner">
                                    ...
                                    <input type="text" name="CaptchaInput2" id="CaptchaInput2" size="15"><br>
