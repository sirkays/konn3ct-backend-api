        ...
        <div class="vertical-align-middle auth-main">
            <div class="auth-box">
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <p>The page you were looking for could not be found, please <a
                                href="mailto:info@5starcompany.com.ng">contact us</a> to report this issue.</p>
                        <div class="margin-top-30">
                            <a href="javascript:history.go(-1)" class="btn btn-default"><i class="fa fa-arrow-left"></i>
                                <span>Go Back</span></a>
                            <a href="{{route('welcome')}}" class="btn btn-primary"><i class="fa fa-home"></i>
                                <span>Home</span></a>
                        </div>
                    </div>
                </div>
