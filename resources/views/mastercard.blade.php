...
@section('content')
    <div class="row mt-5">
        <div class="col-md-12 col-lg-6 ml-4 text-center">
            ...
            <h2 class="text-center mt-5" style="color: #012E89">Amount to Debit : 5USD</h2>
            <h6 class="text-center" style="color: grey">Payment Reference: 7484848843</h6>
        ...
        <div class="col-md-12 col-lg-6 mt-1">
            ...
            <form class="mt-2" method="POST" action="{{ route('login') }}" onsubmit="return checkform(this);">
                ...
                <div class="col-12 text-center mt-4" style="color: grey">
                    Cancel and <a href="{{route('register')}}" style="color: grey">go back?</a>
                </div>
