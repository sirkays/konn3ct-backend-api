        ...
        <div class="inside-header">
            <div class="d-flex align-items-center logo-box justify-content-between">
                ...
                <a href="/" class="logo">
                    ...
                    <div class="logo-lg">
                        <span
                            style="color: white">Welcome, {{\Illuminate\Support\Facades\Auth::user()->firstname}} {{\Illuminate\Support\Facades\Auth::user()->lastname}}</span>
                    ...
                    <div class="col-xl-4">
                        <div class="box">
                            <div class="box-body d-flex p-0">
                                <div class="flex-grow-1 bg-info px-30 pt-50 pb-100 flex-grow-1 bg-img min-h-350"
                                     style="background-position: right bottom; background-size: 40% auto; background-image: url(https://www.multipurposethemes.com/admin/adminto-template/images/svg-icon/color-svg/custom-6.svg)">
...
<div class="modal fade basicplan-modal" id="basicplan-modal" tabindex="-1" role="dialog"
    ...
    function makePayment(cur) {
        ...
        if (cur == "USD") {
            FlutterwaveCheckout({
                ...
                @elseif(\Illuminate\Support\Facades\Auth::user()->plan==3) 16 @endif,
                currency: "USD",
                country: "NG",
                payment_options: "card, mobilemoneyghana, ussd",
                customer: {
            ...
            FlutterwaveCheckout({
                public_key: "{{env('RAVE_PUB_KEY')}}",
                tx_ref: "konn3ct_{{rand().time()}}",
                amount: @if(\Illuminate\Support\Facades\Auth::user()->plan==2) 120
                @elseif(\Illuminate\Support\Facades\Auth::user()->plan==3) 175 @endif,
                currency: "USD",
                country: "NG",
                payment_options: "card, mobilemoneyghana, ussd",
                customer: {
            ...
            FlutterwaveCheckout({
                ...
                @elseif(\Illuminate\Support\Facades\Auth::user()->plan==3) 6000 @endif,
                currency: "NGN",
                country: "NG",
                payment_options: "card, mobilemoneyghana, ussd",
                customer: {
            ...
            FlutterwaveCheckout({
                public_key: "{{env('RAVE_PUB_KEY')}}",
                tx_ref: "konn3ct_{{rand().time()}}",
                amount: @if(\Illuminate\Support\Facades\Auth::user()->plan==2) 46000
                @elseif(\Illuminate\Support\Facades\Auth::user()->plan==3) 67000 @endif,
                currency: "NGN",
                country: "NG",
                payment_options: "card, mobilemoneyghana, ussd",
                customer: {
